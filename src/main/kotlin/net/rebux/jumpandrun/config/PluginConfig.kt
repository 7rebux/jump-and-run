...
class PluginConfig {
  ...
  init {
    ...
    config.addDefault("database.name", "parkour")
    config.addDefault("database.user", "parkour")
    config.addDefault("database.pass", "parkour")
    ...
    config.addDefault("messages.items.hider.enable", "Alle Spieler sind nun ${ChatColor.RED}versteckt${ChatColor.GRAY}!")
    config.addDefault("messages.items.hider.disable", "Alle Spieler werden nun ${ChatColor.GREEN}angezeigt${ChatColor.GRAY}!")
